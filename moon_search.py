...
client = OpenAI(
    ...
    api_key="sk-PeOeoc5ntSZfLFtm9YiOc7NjTas55OK6mkEiz2RoPb2ZQHYx",  # 替换为你的实际 API 密钥
)
...
def main(arg1: str) -> str:
    ...
    return result  # <-- 在这里，我们才将模型生成的回复返回给用户

if __name__ == '__main__':
    arg1 = "Moonshot AI Context Caching 技术，并告诉我它是什么。"  # 替换为你的实际搜索内容
    result = main(arg1)
    return(result)  # <-- 打印结果